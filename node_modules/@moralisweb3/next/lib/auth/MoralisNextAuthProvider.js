    ...
    return (0, credentials_1.default)({
        ...
        authorize: function (credentials) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, message, signature, network, nextAuthUrl, user, e_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            _a = credentials, message = _a.message, signature = _a.signature, network = _a.network;
                            nextAuthUrl = process.env.NEXTAUTH_URL;
                            if (!nextAuthUrl) {
                                throw new Error('NEXTAUTH_URL missing');
                            }
                            return [4 /*yield*/, axios_1.default.post("".concat(nextAuthUrl, "/api/moralis/auth/verifyChallenge").concat(network || moralis_1.default.Core.config.get('defaultNetwork')), { message: message, signature: signature })];
                        case 1:
                            user = (_b.sent()).data;
